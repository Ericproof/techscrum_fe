...
export default function Gdpr() {
  return (
    <TermsAndConditionsLayout title="GDPR Compliance">
      ...
      <p>
        The General Data Protection Regulation (GDPR) was introduced to harmonize data privacy laws
        across Europe, to protect the data privacy of all EU citizens’ data, and to shape the way
        organizations across the region approach data privacy. GDPR replaced the Data Protection
        Directive 95/46/EC and it came into force on May 25th, 2018. The full text of the GDPR can
        be found <a href="https://gdpr-info.eu/">here</a>.
        <br />
        <br />
      ...
      <p>
        ...
        guidance issued by regulatory authorities. The GDPR strengthens individuals’ privacy rights
        through tighter controls over the processing of their personal data, significant expansion
        of their rights over their data, and increased transparency into the nature, purpose, and
        use of it. In our eyes, GDPR is a good thing.
      </p>
      ...
      <p>
        ...
        business, coordinated by our internal Data Protection Officer (DPO). The representatives in
        this group were charged with ensuring that all the requirements of GDPR were addressed
        across all teams.
      </p>
      ...
      <p>
        ...
        we do to you. We made it easy to support your customers and give them the ability to access,
        handle, and delete their personal data. Because we operate on a self-service basis, you’ll
        always have full control over your own data, including autonomy in how you process your
        customers’ information. We also ensure that all of your data – and your customers’ data – is
        easily exportable in a commonly used and computer readable format.
      </p>

      <h3>Breach management</h3>
      <p>
        As part of our HIPAA compliance, we already have management and communication processes in
        place in the unlikely event of a data breach; we’ve updated these to further comply with the
        GDPR regulations.
      </p>
      ...
      <p>
        ...
        questions or concerns regarding how we protect your personal data, please don’t hesitate to
        reach out to us at gdpr@techscrum.com.
      </p>
