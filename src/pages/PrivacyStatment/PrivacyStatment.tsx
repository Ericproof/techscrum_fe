...
import styles from './PrivacyStatment.module.scss';
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.main_content}>
        <div className={styles.content_nav}> </div>
        <div className={styles.content}>
          ...
          <p>
            ...
            for and explains your rights around how we use it. Please read this Privacy Statement to
          ...
          <p>
            ...
            TechScrum.com is the data controller. You will find our contact details in the Contact
            us section below.
          </p>
          ...
          <ul>
            <li>
              <p>
                Training: for customer service training and compliance purposes. We let you know if
                a call is being recorded at the start of the call so you can decide whether to
          ...
          <p>
            ...
            deleted at anytime within this period. We will respond to your request and complete the
          ...
          <p>
            ...
            completely secure. We cannot guarantee the complete security of our databases, nor can
            we guarantee that information you supply will not be intercepted while being transmitted
            to us over the Internet. We will continue to revise policies and implement additional
          ...
          <p>
            ...
            servers or in the cloud. We use cloud solutions for web hosting or proprietary software
            solutions delivered through the Cloud. Your data will not be transferred between our
          ...
          <ul>
            <li>
              <p>
                ...
                to our processing, and that we provide you with a copy of your data (‘access
                right’);
              </p>
            </li>
            <li>
          ...
          <p>
            We reserve the right to change this Statement from time to time in our sole discretion.
            If we make any changes, we will publish those changes on our website. At the bottom of
            this document you will find the date on which this Statement was last updated.
          </p>
          <h2>Contact Us</h2>
          <p>
            Questions, comments, requests and complaints regarding this Statement and the
            information we hold are welcome and should be addressed to us at privacy@techscrum.com.
            We endeavour to deal with all requests promptly and efficiently.
          </p>
          <p>
            ...
            Cork, Ireland, T23 F902, Telephone number +353 21 430 7675 from the USA Tel. +1 844 819
            8453
          </p>
        </div>
      </div>
