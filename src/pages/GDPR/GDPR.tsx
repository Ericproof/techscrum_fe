      ...
      <div className={styles.gdprContent}>
        ...
        <div className={styles.gdprText}>
          ...
          <p>
            ...
            using and protecting personal data, and to be able to demonstrate accountability for
          ...
          <p>
            ...
            in this group were charged with ensuring that all the requirements of GDPR were
            addressed across all teams.
          </p>
          ...
          <p>
            ...
            are collecting and processing customer data. Based on this, we validated our legal basis
            for collecting and processing that personal data. We also ensured that we are applying
            the appropriate safeguards across our entire infrastructure (both hardware and software)
          ...
          <p>
            ...
            share it with, and how long we store it for. As always, we aim to keep the language in
            our Terms of Service and Privacy Policy as clear as possible.
          </p>

          <h3>Data access, portability, and deletion</h3>
          <p>
            We know that you’ll want to provide the same level of GDPR compliance to your customers
            as we do to you. We made it easy to support your customers and give them the ability to
          ...
          <p>
            As part of our HIPAA compliance, we already have management and communication processes
            in place in the unlikely event of a data breach; we’ve updated these to further comply
