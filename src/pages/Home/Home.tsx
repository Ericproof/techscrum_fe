    ...
    <div className={styles.homePage}>
          ...
          <div className={styles.jobDoneRows}>
            ...
            <div className={styles.businessContent}>
              ...
              <div className={styles.jobDoneParagraph}>
                <p>
                  Teamwork gives you the tools and reports you need to maximize resources and never
                  miss a billable minute again. Get a bird&apos;s eye view of every project, from
                  milestones to
              ...
              <div className={styles.jobDoneQuote}>
                ...
                <div className={styles.quoteWrap}>
                  <p className={styles.quoteText}>
                    ...
                    clients. It gives me full oversight on what&apos;s moving and what&apos;s not.”
                  </p>
                  <div className={styles.quoteAuthor}>
      ...
      <section className={styles.cardsSection}>
        <div className={styles.cardsContainer}>
          <h3>
            Skip the learning curve and start immediately with our pre-built <span>templates</span>
          </h3>
          <div className={styles.cardsParagraph}>
            <p>
              No matter the job, <span>Teamwork</span> has a template to get it done. Whether you or
              your client is in marketing, operations, creative, engineering, or IT - we&apos;ve got
              you covered.
            </p>
          </div>
